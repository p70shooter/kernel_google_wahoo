...
$(ANDROID_MAKE_GOALS):
	$(MAKE) -C kernel KBUILD_RELSRC=$(KERNEL_SOURCE_RELATIVE_PATH) O=../$(KERNEL_OUT) ARCH=$(TARGET_ARCH) CROSS_COMPILE=$(KERNEL_TOOLCHAIN_PREFIX) DEFCONFIG=$(TARGET_KERNEL_CONFIG) $(KERNEL_BUILD_TARGETS)
endif
endif
